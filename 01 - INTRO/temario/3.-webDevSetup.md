...
Recordemos que todo lo que hacemos es para nuestro usuario y si nuestro usuario le gusta usar un navegador u otro, nuestra aplicación deberá de ser capaz de brindarle los servicios, independientemente del navegador en el que se encuentre.
...
Una de las más conocidas y usadas es Lighthouse de Google (https://developers.google.com/web/tools/lighthouse?hl=es) , esta la podemos encontrar directamente en el navegador y nos dará una auditoría de como está nuestro sitio en diferentes áreas como rendimiento, accesibilidad, buenas prácticas y SEO.
